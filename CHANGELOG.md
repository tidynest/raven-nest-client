...
changes. Server-side additions: a machine-readable tool manifest
(`docs/MCP_TOOLS.md`) so static MCP security scanners can read the tool surface,
and a reworded `run_gitleaks` description.
